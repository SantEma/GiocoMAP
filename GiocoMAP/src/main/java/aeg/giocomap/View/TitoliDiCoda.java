...
public class TitoliDiCoda extends JPanel {
    ...
    // =========================================================================
    // Pannello con i titoli di coda che scorrono verso l'alto in loop
    // =========================================================================
    private static class PannelloScorrimento extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            // parte dal fondo la prima volta che conosciamo l'altezza reale
        ...
        private BufferedImage creaTitolo(String testo, Font font) {
            ...
            // 1) livello glow: testo dorato pieno, poi sfocato
            ...
            // 2) immagine finale: glow (rinforzato) + testo con gradiente oro
            BufferedImage img = new BufferedImage(w, h, BufferedImage.TYPE_INT_ARGB);
            Graphics2D g2 = img.createGraphics();
            g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            g2.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_ON);
            g2.drawImage(glow, 0, 0, null);
            g2.drawImage(glow, 0, 0, null);   // due passate = alone piu' luminoso
            g2.setFont(font);
        ...
        // singola riga: o testo (font+colore) o immagine pre-renderizzata
        private static class Riga {
            ...
            // costruttore per righe di testo
            ...
            // costruttore per la riga-immagine (titolo con glow)
